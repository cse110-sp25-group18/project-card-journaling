...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function loadEntries() {
    ...
    try {
      ...
      if (entries.length === 0) {
        entriesContainer.innerHTML = '<p>No journal entries found. Create some on the Create Card page.</p>';
        return;
      }
      ...
      entriesContainer.innerHTML = '<p>Error loading entries. Check the console for details.</p>';
    }
  }
